...
(function ($, undefined) {
    $.widget("mobile.progressbar", {
        ...
        _refreshValue: function () {
            ...
            //2014, 06,10
            //buck added to fix two digits after decimal point
            var fixed_percentage=0;
            if(this._percentage()){
            	fixed_percentage=this._percentage().toFixed(2);
            }
            
            if ((typeof this.labelContent !== "undefined")) {
                //buck modify 
            	//this.labelContent.text([this._percentage(), '%'].join(""));
                this.labelContent.text([fixed_percentage, '%'].join(""));
            }
